export const storeCustomization = {
  ...
  home: {
    ...
    quick_delivery_description: {
      en: "There are many products you will find in our shop, Choose your daily necessary product from our BanglaBazar shop and get some special offers. See Our latest discounted products from here and get a special discount.",
      de: "Es gibt viele Produkte, die Sie in unserem Shop finden. Wählen Sie Ihr täglich benötigtes Produkt aus unserem BanglaBazar-Shop und erhalten Sie einige Sonderangebote. Sehen Sie sich hier unsere neuesten reduzierten Produkte an und sichern Sie sich einen Sonderrabatt.",
    },
    ...
    daily_need_title: {
      en: "Get Your Daily Needs From Our BanglaBazar Store",
      de: "Holen Sie sich Ihren täglichen Bedarf in Ihrem CloudCleaver-Shop",
    },
    daily_need_description: {
      en: "There are many products you will find in our shop, Choose your daily necessary product from our BanglaBazar shop and get some special offers.",
      de: "Es gibt viele Produkte, die Sie in unserem Shop finden. Wählen Sie Ihr täglich benötigtes Produkt aus unserem BanglaBazar-Shop und erhalten Sie einige Sonderangebote.",
    },
  ...
  about_us: {
    ...
    top_title: {
      en: "Welcome to our BanglaBazar shop",
      de: "Willkommen in unserem BanglaBazar-Shop",
    },
    top_description: {
  ...
  contact_us: {
    ...
    email_box_email: {
      en: "info@BanglaBazar.com ",
      de: "info@BanglaBazar.com",
    },
    email_box_text: {
  ...
  faq: {
    ...
    faq_one: {
      en: "How does the BanglaBazar work?",
      de: "Wie funktioniert der BanglaBazar?",
    },
    description_one: {
    ...
    faq_five: {
      en: "What is BanglaBazar EC2 auto scaling?",
      de: "Was ist die automatische Skalierung von BanglaBazar EC2?",
    },
    description_five: {
      en: "Continually impact seamless imperatives for best-of-breed best practices. Phosfluorescently facilitate parallel applications with unique imperatives. Proactively plagiarize functionalized deliverables via inexpensive solutions. Collaboratively embrace web-enabled infomediaries rather than diverse testing procedures.",
    ...
    faq_six: {
      en: "What are the benefits of using BanglaBazar affliate?",
  ...
  seo: {
    ...
    meta_description: "React Grocery & Organic Food Store e-commerce",
    meta_img:
      "https://res.cloudinary.com/ahossain/image/upload/v1636729752/facebook-page_j7alju.png",
    meta_keywords: "e-commerce, online store",
    meta_title:
      "BanglaBazar - React Grocery & Organic Food Store e-commerce",
    meta_url: "https://bangla-bazar-store-nine.vercel.app/",
  },
};
